...
export const concept = {
  ...
  groups: [
    {
      label: '情绪',
      items: ['清爽', '自然', '从容', '亲近', '轻盈', '有精神'],
    },
    {
      label: '色调',
      items: ['蓝绿主调', '湖水绿', '窗框青', '暖金高光', '黑白对比', '低饱和'],
    },
    {
      label: '质感',
      items: ['胶片颗粒', '柔焦高光', '轻微过曝', '服装光泽', '水面反光', '石材纹理'],
    },
    {
      label: '构图',
      items: ['中心轴', '大留白', '框景', '斜线引导', '台阶纵深', '环境人像'],
    },
    {
      label: '动作',
      items: ['倚靠栏杆', '行走抓拍', '坐姿正面', '侧脸回头', '手部托腮', '看向窗外'],
    },
    {
      label: '造型',
      items: ['白衬衫', '黑白裙装', '蓝色刺绣', '花束点缀', '干净妆面', '发丝自然'],
    },
  ],
};
